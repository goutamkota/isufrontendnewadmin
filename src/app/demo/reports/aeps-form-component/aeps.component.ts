...
export class AepsTransComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.reportForm = new FormGroup({
            subCat: new FormControl('aeps1', null),
    ...
    subscribeSubCat() {
      ...
      submitReport() {
        ...
        let reportData = {};
        if (this.reportForm.get('subCat').value === 'aeps1') {
            ...
            reportData = {
                ...
                operationPerformed: operationPerformed === 'ALL' ? ["AEPS_CASH_WITHDRAWAL", "AEPS_BALANCE_ENQUIRY", "AEPS_MINI_STATEMENT"] : [operationPerformed],
                transaction_type: ['AEPS2'],
                subcatVal: this.reportForm.get('subCat').value,
                userName,
                status
            };
        ...
        this.aepsData.emit({type: 'aeps', data: reportData});
    }
